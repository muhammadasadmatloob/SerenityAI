...
- **UI/UX:** Responsive, calming, mobile-first design  
...
- **NoSQL Database:** Firebase Firestore (Real-time Chat Logs)  
- **SQL Database:** Neon SQL (PostgreSQL - Structured User Data)  
...
- 📊 **Scalable:** Built with a modern microservice-ready backend.  
...
Frontend/           # Expo Router screens & navigation
...
📈 Analytics: Dashboard to track emotional progress over time.
...
Serenity is a full-stack, AI-powered therapeutic chat application designed for safe, empathetic, and real-time mental health support.
