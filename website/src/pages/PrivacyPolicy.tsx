  ...
  return (
    <div className="min-h-screen bg-background text-text-muted">
      ...
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <h1 className="text-4xl font-bold text-text-main mb-8 tracking-tight">Privacy Policy</h1>
        
        <div className="prose prose-invert max-w-none space-y-6 text-text-muted">
          <p>Last updated: July 2026</p>
          
          <h2 className="text-2xl font-semibold text-text-main mt-10 mb-4">1. Information We Collect</h2>
          ...
          <h2 className="text-2xl font-semibold text-text-main mt-10 mb-4">2. How We Handle Chat Data</h2>
          ...
          <h2 className="text-2xl font-semibold text-text-main mt-10 mb-4">3. Security</h2>
          ...
          <h2 className="text-2xl font-semibold text-text-main mt-10 mb-4">4. Contact Us</h2>
